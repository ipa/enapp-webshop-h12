...
public class PostinancePaymentTest {
    ...
    public void testGetStringToHash(){
        ...
        String expected;
        expected = "AMOUNT=100hslu!comp@ny.websh0pCARDNO=4111111111111111hslu!comp@ny.websh0pCURRENCY=CHFhslu!comp@ny.websh0pOPERATION=REShslu!comp@ny.websh0pORDERID=1234hslu!comp@ny.websh0pPSPID=HSLUiCompanyhslu!comp@ny.websh0p";
